...
import AreaChart from '@/components/dashboard/student/chart1'
import AreaChart2 from '@/components/dashboard/student/chart2'

export default function PerformanceStudent(){
  
    return (
        <div className="flex flex-wrap h-fit py-4 px-4  w-fit gap-4"> 
